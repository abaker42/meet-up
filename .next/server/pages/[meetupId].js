...
// EXTERNAL MODULE: ./pages/api/meetup-detail.js
var meetup_detail = __webpack_require__("/TUk");
...
async function getStaticPaths() {
  const meetups = await Object(meetup_detail["handler"])();
  return {
    fallback: false,
...
async function getStaticProps(context) {
  ...
  const meetup = await Object(meetup_detail["handlerData"])(params);
